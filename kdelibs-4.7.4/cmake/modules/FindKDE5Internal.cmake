# - Find the KDE5 include and library dirs, KDE preprocessors and define a some macros
#
...
#  KDE5_LIBEXEC_INSTALL_DIR - the directory where libexec executables from kdelibs are installed
#  KDE5_BIN_INSTALL_DIR     - the directory where executables from kdelibs are installed
#  KDE5_SBIN_INSTALL_DIR    - the directory where system executables from kdelibs are installed
#  KDE5_DATA_INSTALL_DIR    - the parent directory where kdelibs applications install their data
#  KDE5_HTML_INSTALL_DIR    - the directory where HTML documentation from kdelibs is installed
#  KDE5_CONFIG_INSTALL_DIR  - the directory where config files from kdelibs are installed
#  KDE5_ICON_INSTALL_DIR    - the directory where icons from kdelibs are
#  KDE5_IMPORTS_INSTALL_DIR - the directory where imports from kdelibs are
#  KDE5_KCFG_INSTALL_DIR    - the directory where kconfig files from kdelibs are installed
#  KDE5_LOCALE_INSTALL_DIR  - the directory where translations from kdelibs are installed
#  KDE5_MIME_INSTALL_DIR    - the directory where mimetype desktop files from kdelibs are installed
#  KDE5_SOUND_INSTALL_DIR   - the directory where sound files from kdelibs are installed
#  KDE5_TEMPLATES_INSTALL_DIR     - the directory where templates (Create new file...) from kdelibs are installed
#  KDE5_WALLPAPER_INSTALL_DIR     - the directory where wallpapers from kdelibs are installed
#  KDE5_KCONF_UPDATE_INSTALL_DIR  - the directory where kconf_update files from kdelibs are installed
#  KDE5_AUTOSTART_INSTALL_DIR     - the directory where autostart from kdelibs are installed
#  KDE5_XDG_APPS_INSTALL_DIR      - the XDG apps dir from kdelibs
#  KDE5_XDG_DIRECTORY_INSTALL_DIR - the XDG directory from kdelibs
#  KDE5_SYSCONF_INSTALL_DIR       - the directory where sysconfig files from kdelibs are installed
#  KDE5_MAN_INSTALL_DIR           - the directory where man pages from kdelibs are installed
#  KDE5_INFO_INSTALL_DIR          - the directory where info files from kdelibs are installed
#  KDE5_DBUS_INTERFACES_DIR       - the directory where dbus interfaces from kdelibs are installed
#  KDE5_DBUS_SERVICES_DIR         - the directory where dbus service files from kdelibs are installed
#
# The following variables are defined for the various tools required to
# compile KDE software:
#
#  KDE5_KCFGC_EXECUTABLE    - the kconfig_compiler executable
#  KDE5_AUTOMOC_EXECUTABLE  - the kde5automoc executable, deprecated, use AUTOMOC4_EXECUTABLE instead
#  KDE5_MEINPROC_EXECUTABLE - the meinproc4 executable
#  KDE5_MAKEKDEWIDGETS_EXECUTABLE - the makekdewidgets executable
#
# The following variables point to the location of the KDE libraries,
# but shouldn't be used directly:
#
#  KDE5_KDECORE_LIBRARY     - the kdecore library
#  KDE5_KDEUI_LIBRARY       - the kdeui library
#  KDE5_KIO_LIBRARY         - the kio library
#  KDE5_KPARTS_LIBRARY      - the kparts library
#  KDE5_KUTILS_LIBRARY      - the kutils library
#  KDE5_KEMOTICONS_LIBRARY  - the kemoticons library
#  KDE5_KIDLETIME_LIBRARY   - the kidletime library
#  KDE5_KCMUTILS_LIBRARY    - the kcmutils library
#  KDE5_KPRINTUTILS_LIBRARY - the kprintutils library
#  KDE5_KDE3SUPPORT_LIBRARY - the kde3support library
#  KDE5_KFILE_LIBRARY       - the kfile library
#  KDE5_KHTML_LIBRARY       - the khtml library
#  KDE5_KJS_LIBRARY         - the kjs library
#  KDE5_KJSAPI_LIBRARY      - the kjs public api library
#  KDE5_KNEWSTUFF2_LIBRARY  - the knewstuff2 library
#  KDE5_KNEWSTUFF3_LIBRARY  - the knewstuff3 library
#  KDE5_KDNSSD_LIBRARY      - the kdnssd library
#  KDE5_PHONON_LIBRARY      - the phonon library
#  KDE5_THREADWEAVER_LIBRARY- the threadweaver library
#  KDE5_SOLID_LIBRARY       - the solid library
#  KDE5_KNOTIFYCONFIG_LIBRARY- the knotifyconfig library
#  KDE5_KROSSCORE_LIBRARY   - the krosscore library
#  KDE5_KTEXTEDITOR_LIBRARY - the ktexteditor library
#  KDE5_NEPOMUK_LIBRARY     - the nepomuk library
#  KDE5_PLASMA_LIBRARY      - the plasma library
#  KDE5_KUNITCONVERSION_LIBRARY - the kunitconversion library
#  KDE5_KDEWEBKIT_LIBRARY   - the kdewebkit library
#
#  KDE5_PLASMA_OPENGL_FOUND  - TRUE if the OpenGL support of Plasma has been found, NOTFOUND otherwise
#
...
#
#  KDE5_KDECORE_LIBS          - the kdecore library and all depending libraries
#  KDE5_KDEUI_LIBS            - the kdeui library and all depending libraries
#  KDE5_KIO_LIBS              - the kio library and all depending libraries
#  KDE5_KPARTS_LIBS           - the kparts library and all depending libraries
#  KDE5_KUTILS_LIBS           - the kutils library and all depending libraries
#  KDE5_KEMOTICONS_LIBS       - the kemoticons library and all depending libraries
#  KDE5_KIDLETIME_LIBS        - the kidletime library and all depending libraries
#  KDE5_KCMUTILS_LIBS         - the kcmutils library and all depending libraries
#  KDE5_KPRINTUTILS_LIBS      - the kprintutils library and all depending libraries
#  KDE5_KDE3SUPPORT_LIBS      - the kde3support library and all depending libraries
#  KDE5_KFILE_LIBS            - the kfile library and all depending libraries
#  KDE5_KHTML_LIBS            - the khtml library and all depending libraries
#  KDE5_KJS_LIBS              - the kjs library and all depending libraries
#  KDE5_KJSAPI_LIBS           - the kjs public api library and all depending libraries
#  KDE5_KNEWSTUFF2_LIBS       - the knewstuff2 library and all depending libraries
#  KDE5_KNEWSTUFF3_LIBS       - the knewstuff3 library and all depending libraries
#  KDE5_KDNSSD_LIBS           - the kdnssd library and all depending libraries
#  KDE5_KDESU_LIBS            - the kdesu library and all depending libraries
#  KDE5_KPTY_LIBS             - the kpty library and all depending libraries
#  KDE5_PHONON_LIBS           - the phonon library and all depending librairies
#  KDE5_THREADWEAVER_LIBRARIES- the threadweaver library and all depending libraries
#  KDE5_SOLID_LIBS            - the solid library and all depending libraries
#  KDE5_KNOTIFYCONFIG_LIBS    - the knotify config library and all depending libraries
#  KDE5_KROSSCORE_LIBS        - the kross core library and all depending libraries
#  KDE5_KROSSUI_LIBS          - the kross ui library which includes core and all depending libraries
#  KDE5_KTEXTEDITOR_LIBS      - the ktexteditor library and all depending libraries
#  KDE5_NEPOMUK_LIBS          - the nepomuk library and all depending libraries
#  KDE5_PLASMA_LIBS           - the plasma library and all depending librairies
#  KDE5_KUNITCONVERSION_LIBS  - the kunitconversion library and all depending libraries
#  KDE5_KDEWEBKIT_LIBS        - the kdewebkit library and all depending libraries
#
...
#  PLUGIN_INSTALL_DIR       - the subdirectory relative to the install prefix where plugins will be installed (default is ${KDE5_LIB_INSTALL_DIR}/kde5)
...
#
#  KDE5_ENABLE_FINAL - enable KDE-style enable-final all-in-one-compilation
#  KDE5_BUILD_TESTS  - enable this to build the testcases
#  KDE5_ENABLE_FPIE  - enable it to use gcc Position Independent Executables feature
#  KDE5_USE_COMMON_CMAKE_PACKAGE_CONFIG_DIR - only present for CMake >= 2.6.3, defaults to TRUE
#                      If enabled, the package should install its <package>Config.cmake file to
#                      lib/cmake/<package>/ instead to lib/<package>/cmake
#  KDE5_SERIALIZE_TOOL - wrapper to serialize potentially resource-intensive commands during
#                      parallel builds (set to 'icecc' when using icecream)
#
# It also adds the following macros and functions (from KDE5Macros.cmake)
#  KDE5_ADD_UI_FILES (SRCS_VAR file1.ui ... fileN.ui)
#    Use this to add Qt designer ui files to your application/library.
#
#  KDE5_ADD_UI3_FILES (SRCS_VAR file1.ui ... fileN.ui)
#    Use this to add Qt designer ui files from Qt version 3 to your application/library.
#
#  KDE5_ADD_KCFG_FILES (SRCS_VAR [GENERATE_MOC] [USE_RELATIVE_PATH] file1.kcfgc ... fileN.kcfgc)
#    Use this to add KDE config compiler files to your application/library.
#    Use optional GENERATE_MOC to generate moc if you use signals in your kcfg files.
#    Use optional USE_RELATIVE_PATH to generate the classes in the build following the given
#    relative path to the file.
#
#  KDE5_ADD_WIDGET_FILES (SRCS_VAR file1.widgets ... fileN.widgets)
#    Use this to add widget description files for the makekdewidgets code generator
#    for Qt Designer plugins.
#
#  KDE5_CREATE_FINAL_FILES (filename_CXX filename_C file1 ... fileN)
...
#
#  KDE5_ADD_PLUGIN ( name [WITH_PREFIX] file1 ... fileN )
#    Create a KDE plugin (KPart, kioslave, etc.) from the given source files.
#    It supports KDE5_ENABLE_FINAL.
#    If WITH_PREFIX is given, the resulting plugin will have the prefix "lib", otherwise it won't.
#
#  KDE5_ADD_KDEINIT_EXECUTABLE (name [NOGUI] [RUN_UNINSTALLED] file1 ... fileN)
...
#    KDE5_ADD_EXECUTABLE().
#
#  KDE5_ADD_EXECUTABLE (name [NOGUI] [TEST] [RUN_UNINSTALLED] file1 ... fileN)
#    Equivalent to ADD_EXECUTABLE(), but additionally adds some more features:
#    -support for KDE5_ENABLE_FINAL
#    -support for automoc
...
#
#  KDE5_ADD_LIBRARY (name [STATIC | SHARED | MODULE ] file1 ... fileN)
#    Equivalent to ADD_LIBRARY(). Additionally it supports KDE5_ENABLE_FINAL,
#    includes automoc-handling and sets LINK_INTERFACE_LIBRARIES target property empty.
#    The RPATH is set according to the global RPATH settings as set up by FindKDE5Internal.cmake
...
#
#  KDE5_ADD_UNIT_TEST (testname [TESTNAME targetname] file1 ... fileN)
#    add a unit test, which is executed when running make test
#    it will be built with RPATH poiting to the build dir
#    The targets are always created, but only built for the "all"
#    target if the option KDE5_BUILD_TESTS is enabled. Otherwise the rules for the target
...
#
#
#  KDE5_ADD_APP_ICON (SRCS_VAR pattern)
...
#  There is some workaround in kde5_add_kdeinit_executable to make it possible for those applications as well.
# Parameters:
#  SRCS_VAR  - specifies the list of source files
#  pattern   - regular expression for searching application icons
#  Example: KDE5_ADD_APP_ICON( myapp_SOURCES "pics/cr*-myapp.png")
#  Example: KDE5_ADD_APP_ICON( myapp_KDEINIT_SRCS "icons/oxygen/*/apps/myapp.png")
#
#  KDE5_UPDATE_ICONCACHE()
#    Notifies the icon cache that new icons have been installed by updating
#    mtime of ${ICON_INSTALL_DIR}/hicolor directory.
#
#  KDE5_INSTALL_ICONS( path theme)
#    Installs all png and svgz files in the current directory to the icon
#    directoy given in path, in the subdirectory for the given icon theme.
#
#  KDE5_CREATE_HANDBOOK( docbookfile [INSTALL_DESTINATION installdest] [SUBDIR subdir])
...
#
#  KDE5_CREATE_MANPAGE( docbookfile section )
...
#   SUBDIR <subdir> is specified.
#
#  KDE5_INSTALL_AUTH_ACTIONS( HELPER_ID ACTIONS_FILE )
...
#   the install phase
#
#  KDE5_INSTALL_AUTH_HELPER_FILES( HELPER_TARGET HELPER_ID HELPER_USER )
...
#  the flags for those buildtypes. FindKDE5Internal supports the values
...
#
#  find_package(KDE5 4.1.0 REQUIRED)
#
...
#  _KDE5_PLATFORM_INCLUDE_DIRS is used only internally
#  _KDE5_PLATFORM_DEFINITIONS is used only internally
...
# this is required now by cmake 2.6 and so must not be skipped by if(KDE5_FOUND) below
...
# CMP0000: don't require cmake_minimum_version() directly in the top level CMakeLists.txt, FindKDE5Internal.cmake is good enough
cmake_policy(SET CMP0000 OLD)
# CMP0002: in KDE5 we have multiple targets with the same name for the unit tests
...
# This file can be processed either (usually) included in FindKDE5.cmake or
# (when building kdelibs) directly via FIND_PACKAGE(KDE5Internal), that's why
# we have to check for both KDE5_FIND_REQUIRED and KDE5Internal_FIND_REQUIRED.
if(KDE5_FIND_REQUIRED  OR  KDE5Internal_FIND_REQUIRED)
  set(_REQ_STRING_KDE5 "REQUIRED")
  set(_REQ_STRING_KDE5_MESSAGE "FATAL_ERROR")
else(KDE5_FIND_REQUIRED  OR  KDE5Internal_FIND_REQUIRED)
  set(_REQ_STRING_KDE5 )
  set(_REQ_STRING_KDE5_MESSAGE "STATUS")
endif(KDE5_FIND_REQUIRED  OR  KDE5Internal_FIND_REQUIRED)
...
# find_package(Phonon ${_REQ_STRING_KDE5})


# Check that we really found everything.
# If KDE5 was searched with REQUIRED, we error out with FATAL_ERROR if something wasn't found
# already above in the other FIND_PACKAGE() calls.
# If KDE5 was searched without REQUIRED and something in the FIND_PACKAGE() calls above wasn't found,
...
if(NOT AUTOMOC4_FOUND OR NOT _automoc4_version_ok)
   if(NOT AUTOMOC4_FOUND)
      message(${_REQ_STRING_KDE5_MESSAGE} "KDE5 not found, because Automoc4 not found.")
      return()
   else(NOT AUTOMOC4_FOUND)
      if(NOT _automoc4_version_ok)
         message(${_REQ_STRING_KDE5_MESSAGE} "Your version of automoc4 is too old. You have ${AUTOMOC4_VERSION}, you need at least ${_automoc4_min_version}")
         return()
...
# helper macro, sets both the KDE5_FOO_LIBRARY and KDE5_FOO_LIBS variables to KDE5__foo
# It is used both in bootstrapping and in normal mode.
macro(_KDE5_SET_LIB_VARIABLES _var _lib _prefix)
   set(KDE5_${_var}_LIBRARY ${_prefix}${_lib} )
   set(KDE5_${_var}_LIBS    ${_prefix}${_lib} )
endmacro(_KDE5_SET_LIB_VARIABLES _var _lib _prefix)

#######################  #now try to find some kde stuff  ################################

if (_kdeBootStrapping)
   set(KDE5_INCLUDE_DIR ${kdelibs_SOURCE_DIR})
   ...
   if (WIN32)
      ...
      if (NOT WINCE)
        set(KDE5_KCFGC_EXECUTABLE             ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/kconfig_compiler )
        set(KDE5_MEINPROC_EXECUTABLE          ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/meinproc4 )
      else (NOT WINCE)
        set(KDE5_KCFGC_EXECUTABLE             ${HOST_BINDIR}/${CMAKE_CFG_INTDIR}/kconfig_compiler )
        set(KDE5_MEINPROC_EXECUTABLE          ${HOST_BINDIR}/${CMAKE_CFG_INTDIR}/meinproc4 )
      endif(NOT WINCE)

      set(KDE5_MEINPROC_EXECUTABLE          ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/meinproc4 )
      set(KDE5_KAUTH_POLICY_GEN_EXECUTABLE  ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/kauth-policy-gen )
      set(KDE5_MAKEKDEWIDGETS_EXECUTABLE    ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/makekdewidgets )
   else (WIN32)
      set(LIBRARY_OUTPUT_PATH               ${CMAKE_BINARY_DIR}/lib )
      set(KDE5_KCFGC_EXECUTABLE             ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/kconfig_compiler${CMAKE_EXECUTABLE_SUFFIX}.shell )
      set(KDE5_KAUTH_POLICY_GEN_EXECUTABLE  ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/kauth-policy-gen${CMAKE_EXECUTABLE_SUFFIX}.shell )
      set(KDE5_MEINPROC_EXECUTABLE          ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/meinproc4${CMAKE_EXECUTABLE_SUFFIX}.shell )
      set(KDE5_MAKEKDEWIDGETS_EXECUTABLE    ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR}/makekdewidgets${CMAKE_EXECUTABLE_SUFFIX}.shell )
   endif (WIN32)

   set(KDE5_LIB_DIR ${LIBRARY_OUTPUT_PATH}/${CMAKE_CFG_INTDIR})


   # when building kdelibs, make the kcfg rules depend on the binaries...
   set( _KDE5_KCONFIG_COMPILER_DEP kconfig_compiler)
   set( _KDE5_KAUTH_POLICY_GEN_EXECUTABLE_DEP kauth-policy-gen)
   set( _KDE5_MAKEKDEWIDGETS_DEP makekdewidgets)
   set( _KDE5_MEINPROC_EXECUTABLE_DEP meinproc4)

   set(KDE5_INSTALLED_VERSION_OK TRUE)

else (_kdeBootStrapping)

  # ... but NOT otherwise
   set( _KDE5_KCONFIG_COMPILER_DEP)
   set( _KDE5_MAKEKDEWIDGETS_DEP)
   set( _KDE5_MEINPROC_EXECUTABLE_DEP)
   set( _KDE5_KAUTH_POLICY_GEN_EXECUTABLE_DEP)
   ...
   if (WIN32)
      ...
      get_filename_component(_DIR ${KDE5_KDECONFIG_EXECUTABLE} PATH )
      get_filename_component(KDE5_INSTALL_DIR ${_DIR} PATH )
   ...
   if (NOT KDE_MIN_VERSION)
      if (KDE5_FIND_VERSION_MAJOR)
         set(KDE_MIN_VERSION "${KDE5_FIND_VERSION_MAJOR}.${KDE5_FIND_VERSION_MINOR}.${KDE5_FIND_VERSION_PATCH}")
      else (KDE5_FIND_VERSION_MAJOR)
         set(KDE_MIN_VERSION "4.0.0")
      endif (KDE5_FIND_VERSION_MAJOR)
   endif (NOT KDE_MIN_VERSION)

   #message(FATAL_ERROR "KDE_MIN_VERSION=${KDE_MIN_VERSION}  found ${KDE_VERSION} exact: -${KDE5_FIND_VERSION_EXACT}- version: -${KDE5_FIND_VERSION}-")
   macro_ensure_version( ${KDE_MIN_VERSION} ${KDE_VERSION} KDE5_INSTALLED_VERSION_OK )


   # KDE5_LIB_INSTALL_DIR and KDE5_INCLUDE_INSTALL_DIR are set in KDELibsDependencies.cmake,
   # use them to set the KDE5_LIB_DIR and KDE5_INCLUDE_DIR "public interface" variables
   set(KDE5_LIB_DIR ${KDE5_LIB_INSTALL_DIR} )
   set(KDE5_INCLUDE_DIR ${KDE5_INCLUDE_INSTALL_DIR} )


   # This setting is currently not recorded in KDELibsDependencies.cmake:
   find_file(KDE5_PLASMA_OPENGL_FOUND plasma/glapplet.h PATHS ${KDE5_INCLUDE_DIR} NO_DEFAULT_PATH)
   ...
   get_target_property(_importedConfigurations  ${KDE5_TARGET_PREFIX}kconfig_compiler IMPORTED_CONFIGURATIONS )
   list(GET _importedConfigurations 0 _firstConfig)

   if(NOT WINCE)
   get_target_property(KDE5_KCFGC_EXECUTABLE             ${KDE5_TARGET_PREFIX}kconfig_compiler    LOCATION_${_firstConfig})
   get_target_property(KDE5_MEINPROC_EXECUTABLE          ${KDE5_TARGET_PREFIX}meinproc4           LOCATION_${_firstConfig})
   else(NOT WINCE)
    set(KDE5_KCFGC_EXECUTABLE             ${HOST_BINDIR}/${CMAKE_CFG_INTDIR}/kconfig_compiler )
    set(KDE5_MEINPROC_EXECUTABLE          ${HOST_BINDIR}/${CMAKE_CFG_INTDIR}/meinproc4 )
   endif(NOT WINCE)
   get_target_property(KDE5_KAUTH_POLICY_GEN_EXECUTABLE  ${KDE5_TARGET_PREFIX}kauth-policy-gen    LOCATION_${_firstConfig})
   get_target_property(KDE5_MAKEKDEWIDGETS_EXECUTABLE    ${KDE5_TARGET_PREFIX}makekdewidgets      LOCATION_${_firstConfig})

   # allow searching cmake modules in all given kde install locations (KDEDIRS based)
   execute_process(COMMAND "${KDE5_KDECONFIG_EXECUTABLE}" --path data OUTPUT_VARIABLE _data_DIR ERROR_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE)
   ...
   # the library target "kdeui" is exported as "KDE5__kdeui". The "KDE5__" is used as
   # "namespace" to separate the imported targets from "normal" targets, it is stored in
   # KDE5_TARGET_PREFIX, which is set in KDELibsDependencies.cmake .
   # This export-file is generated and installed by the toplevel CMakeLists.txt of kdelibs.
   ...
   # the kdeui library could now also be used just as "KDE5__kdeui" and still have all their
   ...
   set(KDE5_THREADWEAVER_LIBRARIES ${KDE5_TARGET_PREFIX}threadweaver )

endif (_kdeBootStrapping)


# Set the various KDE5_FOO_LIBRARY/LIBS variables.
# In bootstrapping mode KDE5_TARGET_PREFIX is empty, so e.g. KDE5_KDECORE_LIBRARY
# will be simply set to "kdecore".

# Sorted by names:
_kde5_set_lib_variables(KCMUTILS      kcmutils      "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KDE3SUPPORT   kde3support   "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KDECORE       kdecore       "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KDEUI         kdeui         "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KDEWEBKIT     kdewebkit     "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KDNSSD        kdnssd        "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KEMOTICONS    kemoticons    "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KFILE         kfile         "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KHTML         khtml         "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KIDLETIME     kidletime     "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KIO           kio           "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KJS           kjs           "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KJSAPI        kjsapi        "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KNEWSTUFF2    knewstuff2    "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KNEWSTUFF3    knewstuff3    "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KNOTIFYCONFIG knotifyconfig "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KPARTS        kparts        "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KPRINTUTILS   kprintutils   "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KROSSCORE     krosscore     "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KROSSUI       krossui       "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KTEXTEDITOR   ktexteditor   "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KUNITCONVERSION kunitconversion "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(KUTILS        kutils        "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(PLASMA        plasma        "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(SOLID         solid         "${KDE5_TARGET_PREFIX}")
_kde5_set_lib_variables(THREADWEAVER  threadweaver  "${KDE5_TARGET_PREFIX}")

if (UNIX)
   _kde5_set_lib_variables(KDEFAKES kdefakes "${KDE5_TARGET_PREFIX}")
   _kde5_set_lib_variables(KDESU kdesu       "${KDE5_TARGET_PREFIX}")
   _kde5_set_lib_variables(KPTY kpty         "${KDE5_TARGET_PREFIX}")
endif (UNIX)

# The nepomuk target does not always exist, since is is built conditionally. When bootstrapping
# we set it always anyways.
if(_kdeBootStrapping  OR  TARGET ${KDE5_TARGET_PREFIX}nepomuk)
   _kde5_set_lib_variables(NEPOMUK nepomuk "${KDE5_TARGET_PREFIX}")
endif(_kdeBootStrapping  OR  TARGET ${KDE5_TARGET_PREFIX}nepomuk)


################### try to find Phonon ############################################

# we do this here instead of above together with the checks for Perl etc.
# since FindPhonon.cmake also uses ${KDE5_LIB_INSTALL_DIR} to check for Phonon,
# which helps with finding the phonon installed as part of kdesupport:

# only make Phonon REQUIRED if KDE5 itself is REQUIRED
find_package(Phonon 4.3.80 ${_REQ_STRING_KDE5})
set(KDE5_PHONON_LIBRARY ${PHONON_LIBRARY})
set(KDE5_PHONON_LIBS ${PHONON_LIBS})
set(KDE5_PHONON_INCLUDES ${PHONON_INCLUDES})

if(NOT PHONON_FOUND)
   message(STATUS "KDE5 not found, because Phonon was not found")
   return()
...
option(KDE5_ENABLE_FINAL "Enable final all-in-one compilation")
option(KDE5_BUILD_TESTS  "Build the tests")
option(KDE5_ENABLE_HTMLHANDBOOK  "Create targets htmlhandbook for creating the html versions of the docbook docs")
set(KDE5_SERIALIZE_TOOL "" CACHE STRING "Tool to serialize resource-intensive commands in parallel builds")
...
if(${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION}.${CMAKE_PATCH_VERSION} VERSION_GREATER 2.6.2)
   option(KDE5_USE_COMMON_CMAKE_PACKAGE_CONFIG_DIR "Prefer to install the <package>Config.cmake files to lib/cmake/<package> instead to lib/<package>/cmake" TRUE)
else(${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION}.${CMAKE_PATCH_VERSION} VERSION_GREATER 2.6.2)
   set(KDE5_USE_COMMON_CMAKE_PACKAGE_CONFIG_DIR  FALSE)
...
option(KDE5_ENABLE_FPIE  "Enable platform supports PIE linking")

if (WIN32)
   list(APPEND CMAKE_MODULE_PATH "${CMAKE_INSTALL_PREFIX}/share/apps/cmake/modules")
   find_package(KDEWin REQUIRED)
   option(KDE5_ENABLE_UAC_MANIFEST "add manifest to make vista uac happy" OFF)
   if (KDE5_ENABLE_UAC_MANIFEST)
      find_program(KDE5_MT_EXECUTABLE mt
         PATHS ${KDEWIN_INCLUDE_DIR}/../bin
         NO_DEFAULT_PATH
      )
      if (KDE5_MT_EXECUTABLE)
         message(STATUS "Found KDE manifest tool at ${KDE5_MT_EXECUTABLE} ")
      else (KDE5_MT_EXECUTABLE)
         message(STATUS "KDE manifest tool not found, manifest generating for Windows Vista disabled")
         set (KDE5_ENABLE_UAC_MANIFEST OFF)
      endif (KDE5_MT_EXECUTABLE)
...
if(KDE5_SERIALIZE_TOOL)
   # parallel build with many meinproc invocations can consume a huge amount of memory
   set(KDE5_MEINPROC_EXECUTABLE ${KDE5_SERIALIZE_TOOL} ${KDE5_MEINPROC_EXECUTABLE})
endif(KDE5_SERIALIZE_TOOL)
...
if ("${KDE5_LIB_DIR}" MATCHES lib64)
   set(_Init_LIB_SUFFIX 64)
endif ("${KDE5_LIB_DIR}" MATCHES lib64)
if ("${KDE5_LIB_DIR}" MATCHES lib32)
   set(_Init_LIB_SUFFIX 32)
endif ("${KDE5_LIB_DIR}" MATCHES lib32)
...
# use relative install prefix to avoid hardcoded install paths in cmake_install.cmake files
   ...
   set(PLUGIN_INSTALL_DIR       "lib${LIB_SUFFIX}/kde5"   ) #                "The subdirectory relative to the install prefix where plugins will be installed (default is ${LIB_INSTALL_DIR}/kde5)
   ...
   macro(_SET_FANCY _var _value _comment)
      ...
      if ("${CMAKE_INSTALL_PREFIX}" STREQUAL "${KDE5_INSTALL_DIR}" AND DEFINED KDE5_${_var})
         set(predefinedvalue "${KDE5_${_var}}")
      endif ("${CMAKE_INSTALL_PREFIX}" STREQUAL "${KDE5_INSTALL_DIR}" AND DEFINED KDE5_${_var})
...
#
# the KDE5_xxx_INSTALL_DIR variables are empty when building kdelibs itself
# and otherwise point to the kde5 install dirs

set(CMAKE_SYSTEM_INCLUDE_PATH ${CMAKE_SYSTEM_INCLUDE_PATH}
                              "${KDE5_INCLUDE_INSTALL_DIR}")

set(CMAKE_SYSTEM_PROGRAM_PATH ${CMAKE_SYSTEM_PROGRAM_PATH}
                              "${KDE5_BIN_INSTALL_DIR}" )

set(CMAKE_SYSTEM_LIBRARY_PATH ${CMAKE_SYSTEM_LIBRARY_PATH}
                              "${KDE5_LIB_INSTALL_DIR}" )
...
if (WIN32)
   ...
   if(CYGWIN)
      message(FATAL_ERROR "Cygwin is NOT supported, use mingw or MSVC to build KDE5.")
   endif(CYGWIN)
   ...
   if(MSVC)
      set( _KDE5_PLATFORM_DEFINITIONS -DKDE_FULL_TEMPLATE_EXPORT_INSTANTIATION -DWIN32_LEAN_AND_MEAN )
...
# setup default RPATH/install_name handling, may be overridden by KDE5_HANDLE_RPATH_FOR_EXECUTABLE
...
if (UNIX)
   set( _KDE5_PLATFORM_INCLUDE_DIRS)

   # the rest is RPATH handling
   # here the defaults are set
   # which are partly overwritten in kde5_handle_rpath_for_library()
   # and kde5_handle_rpath_for_executable(), both located in KDE5Macros.cmake, Alex
   if (APPLE)
...
if (APPLE)
  ...
  set ( _KDE5_PLATFORM_DEFINITIONS -D__APPLE_KDE__ )
...
if (CMAKE_SYSTEM_NAME MATCHES Linux OR CMAKE_SYSTEM_NAME STREQUAL GNU)
   if (CMAKE_COMPILER_IS_GNUCXX)
      set ( _KDE5_PLATFORM_DEFINITIONS -D_XOPEN_SOURCE=500 -D_BSD_SOURCE -D_GNU_SOURCE)
...
if (UNIX)
   set ( _KDE5_PLATFORM_DEFINITIONS "${_KDE5_PLATFORM_DEFINITIONS} -D_LARGEFILE64_SOURCE")
...
" _OFFT_IS_64BIT)
   ...
   if (NOT _OFFT_IS_64BIT)
     set ( _KDE5_PLATFORM_DEFINITIONS "${_KDE5_PLATFORM_DEFINITIONS} -D_FILE_OFFSET_BITS=64")
   endif (NOT _OFFT_IS_64BIT)
endif (UNIX)

if (CMAKE_SYSTEM_NAME MATCHES BSD)
   set ( _KDE5_PLATFORM_DEFINITIONS -D_GNU_SOURCE )
...
if (MSVC)
   set (KDE5_ENABLE_EXCEPTIONS -EHsc)
...
if (CMAKE_COMPILER_IS_GNUCXX)
   ...
   set (KDE5_ENABLE_EXCEPTIONS "-fexceptions -UQT_NO_EXCEPTIONS")
   # Select flags.
   ...
   if (__KDE_HAVE_GCC_VISIBILITY AND GCC_IS_NEWER_THAN_4_1 AND NOT _GCC_COMPILED_WITH_BAD_ALLOCATOR AND NOT WIN32)
      ...
      set (KDE5_C_FLAGS "-fvisibility=hidden")
...
if (CMAKE_C_COMPILER MATCHES "icc")
   ...
   set (KDE5_ENABLE_EXCEPTIONS -fexceptions)
   # Select flags.
...
# KDE5Macros.cmake contains all the KDE specific macros
include(${kde_cmake_module_dir}/KDE5Macros.cmake)


# decide whether KDE5 has been found
set(KDE5_FOUND FALSE)
if (KDE5_INCLUDE_DIR AND KDE5_LIB_DIR AND KDE5_KCFGC_EXECUTABLE AND KDE5_INSTALLED_VERSION_OK)
   set(KDE5_FOUND TRUE)
endif (KDE5_INCLUDE_DIR AND KDE5_LIB_DIR AND KDE5_KCFGC_EXECUTABLE AND KDE5_INSTALLED_VERSION_OK)


macro (KDE5_PRINT_RESULTS)

   # inside kdelibs the include dir and lib dir are internal, not "found"
   if (NOT _kdeBootStrapping)
       if(KDE5_INCLUDE_DIR)
          message(STATUS "Found KDE 4.7 include dir: ${KDE5_INCLUDE_DIR}")
       else(KDE5_INCLUDE_DIR)
          message(STATUS "ERROR: unable to find the KDE 4 headers")
       endif(KDE5_INCLUDE_DIR)

       if(KDE5_LIB_DIR)
          message(STATUS "Found KDE 4.7 library dir: ${KDE5_LIB_DIR}")
       else(KDE5_LIB_DIR)
          message(STATUS "ERROR: unable to find the KDE 4 core library")
       endif(KDE5_LIB_DIR)
   endif (NOT _kdeBootStrapping)

   if(KDE5_KCFGC_EXECUTABLE)
      message(STATUS "Found the KDE5 kconfig_compiler preprocessor: ${KDE5_KCFGC_EXECUTABLE}")
   else(KDE5_KCFGC_EXECUTABLE)
      message(STATUS "Didn't find the KDE5 kconfig_compiler preprocessor")
   endif(KDE5_KCFGC_EXECUTABLE)
...
endmacro (KDE5_PRINT_RESULTS)


if (KDE5Internal_FIND_REQUIRED AND NOT KDE5_FOUND)
   #bail out if something wasn't found
   kde5_print_results()
   if (NOT KDE5_INSTALLED_VERSION_OK)
   ...
   endif (NOT KDE5_INSTALLED_VERSION_OK)

   if (NOT KDE5_KCFGC_EXECUTABLE)
     message(FATAL_ERROR "ERROR: could not detect a usable kconfig_compiler")
   endif (NOT KDE5_KCFGC_EXECUTABLE)

   message(FATAL_ERROR "ERROR: could NOT find everything required for compiling KDE 4 programs")
endif (KDE5Internal_FIND_REQUIRED AND NOT KDE5_FOUND)

if (NOT KDE5Internal_FIND_QUIETLY)
   kde5_print_results()
endif (NOT KDE5Internal_FIND_QUIETLY)

#add the found Qt and KDE include directories to the current include path
#the ${KDE5_INCLUDE_DIR}/KDE directory is for forwarding includes, eg. #include <KMainWindow>
set(KDE5_INCLUDES
   ${KDE5_INCLUDE_DIR}
   ${KDE5_INCLUDE_DIR}/KDE
   ${KDE5_PHONON_INCLUDES}
   ${QT_INCLUDES}
   ${_KDE5_PLATFORM_INCLUDE_DIRS}
)

# Used by kdebug.h: the "toplevel dir" is one level above CMAKE_SOURCE_DIR
get_filename_component(_KDE5_CMAKE_TOPLEVEL_DIR "${CMAKE_SOURCE_DIR}/.." ABSOLUTE)
string(LENGTH "${_KDE5_CMAKE_TOPLEVEL_DIR}" _KDE5_CMAKE_TOPLEVEL_DIR_LENGTH)

set(KDE5_DEFINITIONS ${_KDE5_PLATFORM_DEFINITIONS} -DQT_NO_STL -DQT_NO_CAST_TO_ASCII -D_REENTRANT -DKDE_DEPRECATED_WARNINGS -DKDE5_CMAKE_TOPLEVEL_DIR_LENGTH=${_KDE5_CMAKE_TOPLEVEL_DIR_LENGTH})

if (NOT _kde5_uninstall_rule_created)
   set(_kde5_uninstall_rule_created TRUE)

   configure_file("${kde_cmake_module_dir}/kde5_cmake_uninstall.cmake.in" "${CMAKE_BINARY_DIR}/cmake_uninstall.cmake" @ONLY)

   add_custom_target(uninstall "${CMAKE_COMMAND}" -P "${CMAKE_BINARY_DIR}/cmake_uninstall.cmake")

endif (NOT _kde5_uninstall_rule_created)

endif(NOT KDE5_FOUND)
